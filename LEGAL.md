...
- Every fact below is either **VERIFIED** (traced to a real source accessed 2026-09-09,
  cited in §5) or **PLACEHOLDER** (user must confirm — §4).
...
> **Competitive note for user:** TexasLawHelp already gives these forms away free.
...
- Fees **vary by county** across Texas's 254 counties. Anything beyond Harris County
  is PLACEHOLDER until user confirms target counties.
...
## 4. PLACEHOLDER ledger — user must confirm
